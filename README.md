...
When considering my next steps, I started taking Codecademy’s Java course as a refresher and that rekindled my love of programming. I started exploring bootcamp options and made the decision to resign from my position so I could devote myself to studying full time using App Academy Open’s (AAO) self-paced program. Since June 2022 I have been following the AAO coursework, supplementing with other tools and research, and building personal projects. 

Through this process I have discovered a love of JavaScript and front-end development, and feel as though I have come full circle to a field where all of my passions and interests – programming, problem solving, and user experience – come together. My goal is to leverage my diverse skills into a remote Front-End or Full-Stack Development position where I can create exciting and impactful software.
